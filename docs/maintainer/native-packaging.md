...
Final release verification must exercise fresh install, reboot persistence, upgrade, failed health-check rollback, database backup, document persistence, and Official Extension persistence on a clean Ubuntu 22.04 VM snapshot.
