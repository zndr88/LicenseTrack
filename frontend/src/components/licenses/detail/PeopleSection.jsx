        ...
        <div className="dp-section-body" id="dp-section-people">
          ...
          <div className="dp-field">
            ...
            <div className="dp-budget-row">
              {primaryBudgetOwner ? (
                <a href={`mailto:${primaryBudgetOwner}`} className="email-link dp-fieldval-sm" title={primaryBudgetOwner}>
                  <Icon name="mail" size={12} color="var(--orange)" />
                  <span className="dp-email-text">{primaryBudgetOwner}</span>
                </a>
              ) : (
