    ...
    sections: [
      {
        ...
        body: [
          ...
          "Add License opens Review License Data. You can add several license lines, configure included support on supported lines, configure separately tracked support on eligible parent lines, and save the complete batch in one operation. If any line fails validation, none of the licenses are created.",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          "Maintenance Pricing Basis, Covered Quantity, Support Unit Price, and Support Cost: describe included support as either one flat coverage fee or a per-unit calculation. For subscription and SaaS records with included support, Support Cost is derived from the subscription acquisition total and the derived fields are hidden in create and conversion forms.",
          ...
          "PO Total Override: an optional manual whole-PO value used when an invoice has one total but no usable line breakdown. It is shared by every license with that PO number and can be set or cleared from any of those records.",
