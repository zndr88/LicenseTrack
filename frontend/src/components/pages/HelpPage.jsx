...
const HELP_ARTICLES = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "Quote documents belong to sourcing until final license conversion, but they can be downloaded or deleted from the sourcing and pending-order action menus while the related records remain available.",
          ...
          "History tables are paginated. Record fields are read-only there, but evidence can still be downloaded or removed from the row action menu when permitted.",
