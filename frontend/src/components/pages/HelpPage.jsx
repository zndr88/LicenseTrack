    ...
    sections: [
      {
        ...
        body: [
          ...
          "The browser address reflects the page and the selected license, for example /licenses/123. Back and Forward move between pages, a copied address opens the same page or license for a signed-in user who can see it, and after signing in you return to the address you asked for.",
        ],
      },
      {
