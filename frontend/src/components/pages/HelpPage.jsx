    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Unit Price, Total PO Value, and Currency: retain commercial values. Unit Price is line-level pricing; Total PO Value is computed — the sum of quantity × unit price across all licenses sharing a PO number. It cannot be edited directly.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Annual cost totals are active recurring-cost rollups: active, perpetual-status, and expiring subscription, SaaS, and maintenance records are included; upcoming, expired, retired, renewed, and legacy records are excluded.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Recurring annual cost covers active subscription, SaaS, and maintenance records. It excludes upcoming records and is separate from historical PO spend and lifecycle budget.",
