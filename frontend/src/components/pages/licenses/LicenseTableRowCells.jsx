...
function ExpirationCell({ license, upcomingReplacement }) {
  return (
    <div className="lp-expiration-badges">
      ...
      {license.expiration.retiring && <Badge type="gray">{license.expiration.label}</Badge>}
      {license.expiration.status === "expiring" && !upcomingReplacement && !license.expiration.retiring && <Badge type="orange">{license.expiration.label}</Badge>}
      {license.expiration.status === "active" && !license.expiration.retiring && <Badge type="green">{license.expiration.label}</Badge>}
